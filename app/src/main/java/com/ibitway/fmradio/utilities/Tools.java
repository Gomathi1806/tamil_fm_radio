...
public class Tools {
    ...
    public static Bitmap BACKGROUND_IMAGE_ID;
    ...
    public static void HTMLTagValidator(){
        pattern = Pattern.compile(HTML_TAG_PATTERN);
    }

    public static boolean htmlValidate(final String tag){
        if (tag.contains("html") || tag.contains("HTML") || tag.contains("<")){
            return true;
        }
    ...
    public static void initBitmap(Context context){
        BACKGROUND_IMAGE_ID = BitmapFactory.decodeResource(context.getResources(),R.drawable.logo);
    }
